...
wget -N https://epistat.sciensano.be/Data/COVID19BE_CASES_AGESEX.json
wget -N https://epistat.sciensano.be/Data/COVID19BE_CASES_MUNI_CUM.json
wget -N https://epistat.sciensano.be/Data/COVID19BE_HOSP.json
wget -N https://epistat.sciensano.be/Data/COVID19BE_MORT.json
wget -N https://epistat.sciensano.be/Data/COVID19BE_tests.json
